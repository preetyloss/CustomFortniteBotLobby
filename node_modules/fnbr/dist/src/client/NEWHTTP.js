...
class HTTP extends Base_1.default {
    ...
    async request(config, retries = 0) {
        ...
        try {
            ...
            this.client.debug(`${(_a = config.method) === null || _a === void 0 ? void 0 : _a.toUpperCase()} ${config.url} (${reqDuration.toFixed(2)}s): `
            ...
            if (err instanceof axios_1.AxiosError) {
                ...
                this.client.debug(`${config.method} ${config.url} (${reqDuration.toFixed(2)}s): `
                ...
                if (errResponse && (errResponse.status === 429 || (errResponseData === null || errResponseData === void 0 ? void 0 : errResponseData.errorCode) === 'errors.com.epicgames.common.throttled')) {
                    const retryString = errResponse.headers['retry-after']
                        || ((_b = errResponseData === null || errResponseData === void 0 ? void 0 : errResponseData.messageVars) === null || _b === void 0 ? void 0 : _b[0])
                        || ((_d = (_c = errResponseData === null || errResponseData === void 0 ? void 0 : errResponseData.errorMessage) === null || _c === void 0 ? void 0 : _c.match(/(?<=in )\d+(?= second)/)) === null || _d === void 0 ? void 0 : _d[0]);
                ...
                this.client.debug(`${config.method} ${config.url} (${reqDuration.toFixed(2)}s): ${err.name} - ${err.message}`, 'http');
            }
            throw err;
        }
    }
    ...
    async epicgamesRequest(config, auth) {
        var _a, _b, _c, _d;
        if (auth) {
            if (!this.client.auth.sessions.has(auth))
                throw new AuthenticationMissingError_1.default(auth);
            await this.client.auth.lock.wait();
        }
        try {
            ...
            if (err instanceof axios_1.AxiosError) {
                if (auth && constants_1.invalidTokenCodes.includes((_b = (_a = err.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.errorCode)) {
                    await this.client.auth.sessions.get(auth).reauthenticate();
...
//# sourceMappingURL=NEWHTTP.js.map