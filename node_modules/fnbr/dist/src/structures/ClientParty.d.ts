...
import { PartyData, PartyPrivacy, PartySchema, Playlist } from '../../resources/structs';
...
declare class ClientParty extends Party {
    ...
    setPrivacy(privacy: PartyPrivacy, sendPatch?: boolean): Promise<{
        updated: PartySchema;
        deleted: ("Default:PrimaryGameSessionId_s" | "Default:PartyState_s" | "Default:LobbyConnectionStarted_b" | "Default:MatchmakingResult_s" | "Default:MatchmakingState_s" | "Default:SessionIsCriticalMission_b" | "Default:ZoneTileIndex_U" | "Default:ZoneInstanceId_s" | "Default:TheaterId_s" | "Default:TileStates_j" | "Default:MatchmakingInfoString_s" | "Default:CustomMatchKey_s" | "Default:PlaylistData_j" | "Default:AthenaSquadFill_b" | "Default:AllowJoinInProgress_b" | "Default:LFGTime_s" | "Default:PartyIsJoinedInProgress_b" | "Default:GameSessionKey_s" | "Default:RawSquadAssignments_j" | "Default:PrivacySettings_j" | "Default:PlatformSessions_j" | "VoiceChat:implementation_s" | "Default:CreativeDiscoverySurfaceRevisions_j" | "Default:PartyMatchmakingInfo_j" | "urn:epic:cfg:presence-perm_s" | "urn:epic:cfg:accepting-members_b" | "urn:epic:cfg:invite-perm_s" | "urn:epic:cfg:not-accepting-members" | "urn:epic:cfg:not-accepting-members-reason_i")[];
    }>;
    /**
