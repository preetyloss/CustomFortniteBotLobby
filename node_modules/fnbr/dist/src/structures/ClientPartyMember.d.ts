import { CosmeticEnlightment, CosmeticVariant, PartyMemberData, PartyMemberSchema } from '../../resources/structs';
...
declare class ClientPartyMember extends PartyMember {
     ...
     * @throws {EpicgamesAPIError}
     */
    setOutfit(cid: string, variants?: CosmeticVariant[], enlightment?: CosmeticEnlightment | []): Promise<void>;
    /**
     ...
     * @throws {EpicgamesAPIError}
     */
    setBackpack(bid: string, variants?: CosmeticVariant[]): Promise<void>;
    /**
     * Updates the client party member's pet
     * @param id The pet's ID
     * @param variants The pet's variants
     */
    setPet(id: string, variants?: CosmeticVariant[]): Promise<void>;
    /**
     ...
     * @throws {EpicgamesAPIError}
     */
    setPickaxe(id: string, variants?: CosmeticVariant[]): Promise<void>;
    /**
     ...
     * @throws {EpicgamesAPIError}
     */
    setEmoji(id: string): Promise<void>;
    /**
     ...
     * @throws {EpicgamesAPIError}
     */
    setAssistedChallenge(questItemDef?: string, objectivesCompleted?: number): Promise<void>;
    /**
     ...
     * @throws {EpicgamesAPIError}
     */
    setCrowns(crowns: number): Promise<void>;
}
