...
class PartyMemberMeta extends Meta_1.default {
    ...
    get outfit() {
        var _a, _b, _c, _d;
        return (_d = (_c = (_b = (_a = this.get('Default:AthenaCosmeticLoadout_j')) === null || _a === void 0 ? void 0 : _a.AthenaCosmeticLoadout) === null || _b === void 0 ? void 0 : _b.characterDef) === null || _c === void 0 ? void 0 : _c.match(/(?<=\w*\.)\w*/)) === null || _d === void 0 ? void 0 : _d.shift();
    }
    /**
    ...
    get variants() {
        var _a, _b;
        const variants = (_b = (_a = this.get('Default:AthenaCosmeticLoadoutVariants_j')) === null || _a === void 0 ? void 0 : _a.AthenaCosmeticLoadoutVariants) === null || _b === void 0 ? void 0 : _b.vL;
        if (!variants)
            return {};
        const pascalCaseVariants = {};
    ...
    get match() {
        ...
        const hasPreloadedAthena = (_b = (_a = this.get('Default:LobbyState_j')) === null || _a === void 0 ? void 0 : _a.LobbyState) === null || _b === void 0 ? void 0 : _b.hasPreloadedAthena;
    ...
    get assistedChallenge() {
        var _a;
        const challenge = (_a = this.get('Default:AssistedChallengeInfo_j')) === null || _a === void 0 ? void 0 : _a.AssistedChallengeInfo;
        if (!challenge)
            return undefined;
        return {
