...
const actualVersion = 'https://raw.githubusercontent.com/DarkDusOfficial/CustomFortniteBotLobby/main/client/config.json';
const localFilePath = path.resolve(__dirname, '../../client/config.json');
